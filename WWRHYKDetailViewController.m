...
- (void)viewDidLoad 
{
    ...
    _usedKnownLabel.frame = CGRectMake(2, _usedKnownDetailLabel.frame.origin.y - 11 ,60, 40);
    ...
    _goodInfoLabel.frame = CGRectMake(2, _goodInfoDetailLabel.frame.origin.y - 11, 60, 40);
